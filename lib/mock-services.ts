...
export const SERVICE_CATEGORIES: ServiceCategoryMeta[] = [
  {
    id: "PRUNING",
    labelKa: "გასხვლა & ფორმირება",
    labelEn: "Pruning & Shaping",
  ...
  {
    id: "TRANSPLANT",
    labelKa: "გადარგვა & მოვლა",
    labelEn: "Repotting & Care",
