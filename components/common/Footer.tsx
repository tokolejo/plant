    ...
    <footer className="w-full border-t border-border/70 bg-surface-container-lowest/80 dark:bg-card/40 mt-12 pb-24 lg:pb-8 transition-colors">
      <div className="container mx-auto px-4 sm:px-6 py-10 sm:py-12 max-w-7xl">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 lg:gap-10">
          ...
          <div className="col-span-2 md:col-span-1 lg:col-span-2 space-y-3.5">
            <Link href="/" className="inline-flex items-center gap-2.5 group">
              <div className="flex h-8.5 w-8.5 items-center justify-center rounded-xl bg-primary text-white shadow-ambient group-hover:scale-105 transition-transform">
            ...
            <div className="flex items-center gap-2 pt-1.5">
              <a
                ...
                aria-label="Facebook"
                className="w-7.5 h-7.5 rounded-lg border border-border/80 bg-card hover:bg-primary/10 hover:border-primary/40 hover:text-primary flex items-center justify-center text-muted-foreground transition-all cursor-pointer"
              >
        ...
        {/* Bottom Bar — Pixel-perfect alignment with the container */}
        <div className="border-t border-border/60 mt-10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-muted-foreground font-medium text-center sm:text-left">
