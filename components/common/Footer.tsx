  ...
  return (
    <footer className="w-full border-t border-border/70 bg-surface-container-lowest/80 dark:bg-card/40 mt-12 pb-24 lg:pb-8 transition-colors">
      <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-10 max-w-5xl">
        ...
        {/* Bottom Bar */}
        <div className="border-t border-border/60 mt-8 pt-5 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-muted-foreground font-medium text-center sm:text-left">
