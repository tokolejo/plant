          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="space-y-2 text-xs text-muted-foreground">
              ...
              <div className="flex items-center gap-2">
                ...
                <a href="mailto:info@plant.ge" className="hover:text-primary transition-colors">
                  info@plant.ge
                </a>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2 pt-1">
              <a
                ...
                aria-label="Facebook"
                className="w-8 h-8 rounded-xl border border-border/80 bg-card hover:bg-primary/10 hover:border-primary/40 hover:text-primary flex items-center justify-center text-muted-foreground transition-all cursor-pointer"
              >
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-xs text-muted-foreground font-medium">
              ...
              <li className="flex items-center gap-1.5 text-muted-foreground/80">
                <span>{isKa ? "მებაღეების სერვისები" : "Gardener Services"}</span>
