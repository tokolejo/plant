    ...
    <footer className="w-full border-t border-border/70 bg-surface-container-lowest/80 dark:bg-card/40 mt-12 pb-24 lg:pb-8 transition-colors">
      <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-12 max-w-7xl">
        <div className="grid grid-cols-2 lg:grid-cols-5 gap-6 sm:gap-8 lg:gap-10">
          ...
          {/* Top/Left: Brand & Quick Contact (Full Width on Mobile, 2 Cols on Desktop) */}
          <div className="col-span-2 lg:col-span-2 space-y-3 pb-4 border-b border-border/40 lg:border-b-0 lg:pb-0">
            <Link href="/" className="inline-flex items-center gap-2.5 group">
              <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-primary text-white shadow-ambient group-hover:scale-105 transition-transform">
            ...
            <div className="flex items-center gap-2 pt-1">
              <a
                ...
                aria-label="Facebook"
                className="w-7.5 h-7.5 rounded-xl border border-border/80 bg-card hover:bg-primary/10 hover:border-primary/40 hover:text-primary flex items-center justify-center text-muted-foreground transition-all cursor-pointer"
              >
          ...
          {/* Column 2: მარკეტპლეისი (1 col on mobile) */}
          ...
          {/* Column 3: გამყიდველებისთვის (1 col on mobile) */}
          <div className="col-span-1">
            <h4 className="text-xs font-bold uppercase tracking-wider text-foreground mb-2.5">
          ...
          {/* Column 4: დახმარება & წესები (Spans 2 cols on mobile for balanced 2-column grid) */}
          <div className="col-span-2 lg:col-span-1 pt-3 sm:pt-0 border-t border-border/40 sm:border-t-0">
            <h4 className="text-xs font-bold uppercase tracking-wider text-foreground mb-2.5">
              {isKa ? "დახმარება & წესები" : "Support & Legal"}
            </h4>
            <ul className="grid grid-cols-2 lg:grid-cols-1 gap-2 text-xs text-muted-foreground font-medium">
              <li>
                <Link href="/faq" className="hover:text-primary transition-colors">
        ...
        {/* Bottom Bar */}
        <div className="border-t border-border/60 mt-8 sm:mt-10 pt-5 sm:pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-muted-foreground font-medium text-center sm:text-left">
