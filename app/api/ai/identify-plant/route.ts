  ...
  try {
    ...
    return NextResponse.json({
      ...
      data: {
        ...
        wateringKa: taxon.wateringKa,
        wateringEn: taxon.wateringEn,
        light: taxon.lightKa,
        lightKa: taxon.lightKa,
        lightEn: taxon.lightEn,
        careDifficulty: taxon.difficulty,
        toxicity: taxon.toxicityKa,
        toxicityKa: taxon.toxicityKa,
        toxicityEn: taxon.toxicityEn,
