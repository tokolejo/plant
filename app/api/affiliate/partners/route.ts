...
const DEFAULT_PARTNERS: PartnerRecord[] = [
  {
    ...
    badge_color: "#16a34a",
    referral_param_template: "?ref=plantio",
    commission_rate: 5.0,
    is_active: true,
  },
  {
  ...
  },
  {
    ...
    badge_color: "#059669",
    referral_param_template: "?utm_source=plantio",
    commission_rate: 7.0,
    is_active: true,
  },
  {
  ...
  },
  {
    ...
    badge_color: "#d97706",
    referral_param_template: "?tag=plantio-20",
    commission_rate: 4.0,
    is_active: true,
  },
];
...
export async function POST(req: NextRequest) {
  try {
    ...
    const newPartner: PartnerRecord = {
      ...
      referral_param_template: referral_param_template?.trim() || "?ref=plantio",
